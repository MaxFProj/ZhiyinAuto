...
public:
    ...
    static const QString appName() { return tr("ZhiyinAuto"); }
    ...
    static const QString appVer() {return  QString("3.0"); }
    ...
    static const QString organization() { return tr("None"); }
    static const QString organizationHost() { return tr("None"); }
    static const QString webSite() { return tr("None"); }
    static const QString downloadSite() {return tr("None");}
