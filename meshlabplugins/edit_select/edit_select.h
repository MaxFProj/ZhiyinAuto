...
#include "ui_selectVerticesDialog.h"
...
public:
	enum { SELECT_FACE_MODE, SELECT_VERT_MODE, SELECT_CONN_MODE, SELECT_DEFORMATION_VERT_MODE,
	};
	...
	QDialog* deformationDialog;
	Ui::SelectVerticesDialog deformationDialogUI;
