...
void DecorateBasePlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DecorateBasePlugin *_t = static_cast<DecorateBasePlugin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DecorateBasePlugin::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DecorateBasePlugin::askViewerShot)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DecorateBasePlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DecorateBasePlugin.data,
      qt_meta_data_DecorateBasePlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DecorateBasePlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DecorateBasePlugin.stringdata0))
        return static_cast<void*>(const_cast< DecorateBasePlugin*>(this));
    if (!strcmp(_clname, "MeshDecorateInterface"))
        return static_cast< MeshDecorateInterface*>(const_cast< DecorateBasePlugin*>(this));
    if (!strcmp(_clname, "vcg.meshlab.MeshDecorateInterface/1.0"))
        return static_cast< MeshDecorateInterface*>(const_cast< DecorateBasePlugin*>(this));
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x12, 0x00, 'D',  'e',  'c',  'o',  'r',  'a', 
    't',  'e',  'B',  'a',  's',  'e',  'P',  'l', 
    'u',  'g',  'i',  'n',  'z',  0xc0, 0xa0, 0x00,
