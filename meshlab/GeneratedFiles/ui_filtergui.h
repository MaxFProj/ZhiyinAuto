...
public:
    ...
    void setupUi(QFrame *FilterCreatorGUI)
    {
        if (FilterCreatorGUI->objectName().isEmpty())
            FilterCreatorGUI->setObjectName(QStringLiteral("FilterCreatorGUI"));
        ...
        paramviewer->setObjectName(QStringLiteral("paramviewer"));
        ...
        functionLine->setObjectName(QStringLiteral("functionLine"));
        ...
        arity->setObjectName(QStringLiteral("arity"));
        ...
        precond->setObjectName(QStringLiteral("precond"));
        ...
        postcond->setObjectName(QStringLiteral("postcond"));
        ...
        isinterr->setObjectName(QStringLiteral("isinterr"));
    ...
    {
        FilterCreatorGUI->setWindowTitle(QApplication::translate("FilterCreatorGUI", "Filter Editor", Q_NULLPTR));
        label->setText(QApplication::translate("FilterCreatorGUI", "Filter Name", Q_NULLPTR));
        nameLine->setText(QString());
        groupBox_2->setTitle(QApplication::translate("FilterCreatorGUI", "Parameters Viewer", Q_NULLPTR));
        label_2->setText(QApplication::translate("FilterCreatorGUI", "Filter JS Function ", Q_NULLPTR));
        label_4->setText(QApplication::translate("FilterCreatorGUI", "Category", Q_NULLPTR));
        label_3->setText(QApplication::translate("FilterCreatorGUI", "Arity", Q_NULLPTR));
        label_5->setText(QApplication::translate("FilterCreatorGUI", "Pre-Conditions", Q_NULLPTR));
        label_6->setText(QApplication::translate("FilterCreatorGUI", "Post-Conditions", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("FilterCreatorGUI", "Filter Help", Q_NULLPTR));
        isinterr->setText(QApplication::translate("FilterCreatorGUI", "Is Interruptible", Q_NULLPTR));
    } // retranslateUi
