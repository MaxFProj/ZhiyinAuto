...
void GLArea::paintEvent(QPaintEvent* /*event*/)
{
    ...
    if(!this->md()->isBusy())
    {
        ...
        // draw coordinates
        if (mm()) {
            vcg::CoordinateFrame(md()->bbox().Diag() / 2.0).Render(this, &painter);
        }
    ...
    //show current mode
    QString title = QApplication::translate("", "\346\223\215\344\275\234\346\217\220\347\244\272", Q_NULLPTR);
    if (!(iEdit && !suspendedEditor)) {
        QString content = QApplication::translate("", "<table style='font-size: 20px;font-family:Microsoft YaHei'>" 
            "<tr><td>\347\247\273\345\212\250\346\250\241\345\274\217 </td></tr></table>", Q_NULLPTR);
        md()->Log.RealTimeLog(title, "", content);
    }
    else {
        QString content = QApplication::translate("","<table style='font-size: 20px;font-family:Microsoft YaHei'>"
            "<tr><td>\344\277\256\346\224\271\346\250\241\345\274\217 </td></tr></table>", Q_NULLPTR);
        md()->Log.RealTimeLog(title, "", content);
    }

    //
    if (md() && md()->mm()) {
        QString title2  = QApplication::translate("", "\345\275\223\345\211\215\346\250\241\345\236\213", Q_NULLPTR);
        QString label = md()->mm()->label();
        label = label.replace(QChar('&'), '_');
        QString content2 = "<table style='font-size: 20px;font-family:Microsoft YaHei'> <tr><td>" + label +
            "</td></tr></table>";
        md()->Log.RealTimeLog(title2, "", content2);
    }
...
void GLArea::setView()
{
    ...
    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();
    gluLookAt(0, 0, cameraDist,0, 0, 0, 1, 0, 0);
}
