...
void LicenseCheckerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LicenseCheckerThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (LicenseCheckerThread::*)(int , const QString & , const QString & , int * , QMessageBox::StandardButtons , QMessageBox::StandardButton );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LicenseCheckerThread::message)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LicenseCheckerThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LicenseCheckerThread::exitApp)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LicenseCheckerThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_LicenseCheckerThread.data,
    qt_meta_data_LicenseCheckerThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
