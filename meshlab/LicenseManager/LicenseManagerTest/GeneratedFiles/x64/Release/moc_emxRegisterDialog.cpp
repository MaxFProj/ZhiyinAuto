...
void emxRegisterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<emxRegisterDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject emxRegisterDialog::staticMetaObject = { {
    &QWizard::staticMetaObject,
    qt_meta_stringdata_emxRegisterDialog.data,
    qt_meta_data_emxRegisterDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject registerationModePage::staticMetaObject = { {
    &QWizardPage::staticMetaObject,
    qt_meta_stringdata_registerationModePage.data,
    qt_meta_data_registerationModePage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject registerationPage::staticMetaObject = { {
    &QWizardPage::staticMetaObject,
    qt_meta_stringdata_registerationPage.data,
    qt_meta_data_registerationPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
