...
{
	defaultGlobalParamSet->addParam(new RichColor(backgroundBotColorParam(), QColor(102,102,102), "MeshLab Bottom BackGround Color", "MeshLab GLarea's BackGround Color(bottom corner)"));
	defaultGlobalParamSet->addParam(new RichColor(backgroundTopColorParam(), QColor(102, 102, 102), "MeshLab Top BackGround Color", "MeshLab GLarea's BackGround Color(top corner)"));
