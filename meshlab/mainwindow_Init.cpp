	...
	:mwsettings(), gpumeminfo(NULL), xmlfiltertimer(), wama()
{
	...
	QIcon icon;
	icon.addPixmap(QPixmap(":images/logo2.png"));
	setWindowIcon(icon);
	...
	addDockWidget(Qt::BottomDockWidgetArea, plugingui);
	plugingui->hide();
...
void MainWindow::createActions()
{
	...
	//////////////Action Menu File ////////////////////////////////////////////////////////////////////////////
	newProjectAct = new QAction(QIcon(":/images/new_project.png"), tr(""), this); //New Empty Project...
	newProjectAct->setIconText(QApplication::translate("", "\346\226\260\345\267\245\347\250\213", Q_NULLPTR));
	...
	importMeshAct = new QAction(QIcon(":/images/import_mesh.png"), tr(""), this); //&Import Mesh...
	importMeshAct->setIconText(QApplication::translate("", "\346\211\223\345\274\200\346\226\207\344\273\266", Q_NULLPTR));
...
//////////////Action Menu View ////////////////////////////////////////////////////////////////////////////
	...
	showInfoPaneAct->setChecked(true);
...
void MainWindow::createToolBars()
{
	...
	mainToolBar->setStyleSheet("font: bold;font-size: 10px; font-family: 'Microsoft YaHei'");

	mainToolBar->addAction(this->newProjectAct);
	mainToolBar->addSeparator();
	mainToolBar->addAction(importMeshAct);

	globrendtoolbar = nullptr;
	...
	editToolBar->setStyleSheet("font: bold;font-size: 10px;font-family: 'Microsoft YaHei'");
	...
	//filterToolBar->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);
...
void MainWindow::createMenus()
{
	...
	this->addAction(suspendEditModeAct);
